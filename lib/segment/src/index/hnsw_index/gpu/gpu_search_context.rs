...
use crate::index::hnsw_index::gpu::{GPU_DEVICE, GPU_INSTANCE};
...
impl GpuSearchContext {
    ...
    pub fn new(
        ...
        let (_instance, device) = if create_new_device {
            ...
            (GPU_INSTANCE.clone()?, GPU_DEVICE.clone()?)
        };
...
mod tests {
    ...
    fn test_gpu_heuristic() {
        ...
        let shader = ShaderBuilder::new(test.gpu_search_context.device.clone())
            ...
            .with_distance(test.gpu_search_context.gpu_vector_storage.distance)
            .with_sq_multiplier(test.gpu_search_context.gpu_vector_storage.sq_multiplier)
            .with_sq_diff(test.gpu_search_context.gpu_vector_storage.sq_diff)
